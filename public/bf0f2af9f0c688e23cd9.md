---
title: '[CovsirPhy] COVID-19データ解析用Pythonパッケージ: Parameter estimation'
tags:
  - Python
  - コロナウイルス
  - SIRモデル
  ...
  - CovsirPhy
private: false
updated_at: '2020-12-24T19:45:06+09:00'
id: bf0f2af9f0c688e23cd9
...
※v2.13.0以降`DataLoader.japan()`の呼び出しが不要になりました。（2020/12/24追記）
